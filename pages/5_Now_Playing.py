...
if sp is None:
    st.info(
        ":material/lock: Conecta tu cuenta de Spotify para usar el reproductor.",
        icon=":material/lock:",
    )
    st.stop()

# ---------------------------------------------------------------------------
# Currently Playing — Hero section (auto-refresh every 5s)
# ---------------------------------------------------------------------------
...
def _hero_section():
    """Auto-refreshing hero: current track, progress, controls."""
